  ...
  return (
    <main className="min-h-[100svh] bg-gradient-to-b from-red-50 to-gray-50 text-gray-800">
      <div className="mx-auto w-full max-w-md px-3 sm:px-4 pb-24 sm:pb-28 pt-4">
        ...
        {/* Welcome Section */}
        <section className="mb-6 rounded-3xl bg-gradient-to-r from-slate-600 to-slate-700 p-4 sm:p-6 text-white shadow-xl">
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] items-center gap-3 sm:gap-4">
            <div>
              <div className="mb-2 text-xs sm:text-sm opacity-90">Ucapan Selamat Datang</div>
              <div className="flex h-16 sm:h-20 items-center justify-center rounded-xl bg-white/20 text-xs sm:text-sm font-medium backdrop-blur-sm px-2">
                Foto Kepala Desa
              </div>
            </div>
            <div className="text-center">
              <div className="mb-2 flex justify-center">
                <div className="relative">
                  ...
                  <Building2 className="h-4 w-4 sm:h-6 sm:w-6 absolute -bottom-1 -right-1 text-white bg-slate-600 rounded-full p-0.5" />
                </div>
              </div>
        ...
        <section className="mb-6">
          ...
          <div className="rounded-3xl bg-white/90 p-3 sm:p-4 shadow-xl ring-1 ring-blue-200 backdrop-blur-sm">
            <div className="mb-4 text-center text-xs sm:text-sm font-semibold text-blue-700">
              Foto Berita Terbaru
            </div>
            <div className="rounded-2xl bg-gradient-to-br from-blue-100 to-blue-200 p-8 sm:p-12 text-center shadow-inner">
              <div className="relative mx-auto">
                <Newspaper className="h-12 w-12 sm:h-16 sm:w-16 text-blue-600" />
                <Camera className="h-4 w-4 sm:h-6 sm:w-6 absolute -bottom-1 -right-1 text-blue-700 bg-blue-200 rounded-full p-0.5" />
              </div>
            </div>
        ...
        <section className="mb-6">
          ...
          <div className="rounded-3xl bg-white/90 p-3 sm:p-4 shadow-xl ring-1 ring-amber-200 backdrop-blur-sm">
            <div className="mb-4 text-center text-xs sm:text-sm font-semibold text-amber-700">
              Produk
            </div>
            <div className="rounded-2xl bg-gradient-to-br from-amber-100 to-amber-200 p-8 sm:p-12 text-center shadow-inner">
              <div className="relative mx-auto">
                <Store className="h-12 w-12 sm:h-16 sm:w-16 text-amber-600" />
                <ShoppingBag className="h-4 w-4 sm:h-6 sm:w-6 absolute -bottom-1 -right-1 text-amber-700 bg-amber-200 rounded-full p-0.5" />
              </div>
            </div>
            <div className="mt-4 text-center">
              <div className="flex justify-center gap-2">
