...
export default function PaketAktaPerceraianPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    alert("Permohonan paket akta perceraian berhasil diajukan!");
  };

  return (
    <main className="min-h-[100svh] bg-red-50 text-gray-900">
      <div className="mx-auto w-full max-w-md px-4 pb-24 pt-4">
        <HeaderCard title="Paket Akta Perceraian" backUrl="/masyarakat/layanan-publik/pelayanan-taring-dukcapil" />
        ...
        <div className="mb-6 text-center">
          <div className="mx-auto mb-4 grid h-20 w-20 place-items-center rounded-2xl bg-white/90 shadow-lg ring-1 ring-red-200">
            <DivorceIcon className="h-12 w-12 text-red-600" />
          </div>
          <h2 className="text-lg font-bold text-gray-800">Paket Akta Perceraian</h2>
        </div>
