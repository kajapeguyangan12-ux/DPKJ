...
export default function SuratPindahDomisiliPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    alert("Permohonan surat pindah domisili berhasil diajukan!");
  };
      ...
      <div className="mx-auto w-full max-w-md px-4 pb-24 pt-4">
        ...
        <div className="mb-6 text-center">
          <div className="mx-auto mb-4 grid h-20 w-20 place-items-center rounded-2xl bg-white/90 shadow-lg ring-1 ring-red-200">
            <MovingIcon className="h-12 w-12 text-red-600" />
          </div>
          <h2 className="text-lg font-bold text-gray-800">Surat Pindah Domisili</h2>
        </div>
